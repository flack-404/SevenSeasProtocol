...
export const CONTRACT_ABIS = {
  ...
  AgentController: [
    'function registerAgent(uint8 agentType) external',
    ...
    'function agents(address) view returns (uint256 shipId, address owner, uint8 agentType, uint256 eloRating, uint256 wins, uint256 losses, uint256 bankroll, bool isActive)',
  ...
  WagerArena: [
    ...
    'function getMatchDetails(uint256 matchId) external view returns (address agent1, address agent2, uint256 wagerAmount, bool isAccepted, bool isCompleted, address winner)',
  ...
  PredictionMarket: [
    'function placeBet(uint256 predictionId, bool betOnAgent1) external',
