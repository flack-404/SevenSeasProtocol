...
export interface SEASTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "FAUCET_AMOUNT"
      | "MAX_SUPPLY"
...
export interface SEASToken extends BaseContract {
  connect(runner?: ContractRunner | null): SEASToken;
  waitForDeployment(): Promise<this>;

  interface: SEASTokenInterface;
  ...
  claimTestTokens: TypedContractMethod<[], [void], "nonpayable">;
