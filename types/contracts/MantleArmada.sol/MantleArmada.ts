...
export namespace ArenaContractSetEvent {
  export type InputTuple = [arena: AddressLike];
  export type OutputTuple = [arena: string];
  export interface OutputObject {
    arena: string;
  }
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export namespace DuelExecutedEvent {
  export type InputTuple = [
    agent1: AddressLike,
    agent2: AddressLike,
    winner: AddressLike,
...
export interface MantleArmada extends BaseContract {
  ...
  getEvent(
    ...
    DuelExecutedEvent.InputTuple,
    DuelExecutedEvent.OutputTuple,
    DuelExecutedEvent.OutputObject
  >;
  getEvent(
    key: "GPMClaimed"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "DuelExecuted(address,address,address,uint256)": TypedContractEvent<
      DuelExecutedEvent.InputTuple,
      DuelExecutedEvent.OutputTuple,
      DuelExecutedEvent.OutputObject
    >;
    DuelExecuted: TypedContractEvent<
      DuelExecutedEvent.InputTuple,
      DuelExecutedEvent.OutputTuple,
      DuelExecutedEvent.OutputObject
    >;
